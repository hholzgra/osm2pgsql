...
#ifndef OUTPUT_MYSQL_H
#define OUTPUT_MYSQL_H

#include "output.hpp"

class output_mysql_t : public output_t {
public:
    output_mysql_t(const middle_query_t* mid_, const options_t &options);
    output_mysql_t(const output_mysql_t& other);
    virtual ~output_mysql_t();
